...
export const PresenceSettings = Schema.Struct({
...
export const ServerSettings = Schema.Struct({
  ...
  presence: PresenceSettings.pipe(Schema.withDecodingDefault(Effect.succeed({}))),
});
...
export const ServerSettingsPatch = Schema.Struct({
  ...
  presence: Schema.optionalKey(PresenceSettingsPatch),
